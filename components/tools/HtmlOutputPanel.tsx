      ...
      <div className="flex items-center justify-between px-3 py-2 bg-gray-50 border-b border-gray-200 rounded-t-lg gap-2 flex-wrap">
        <div className="flex items-center gap-1">
          <button
            ...
            className={`text-xs px-2.5 py-1 rounded-md font-medium ${tab === 'preview' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 border border-gray-300'}`}
          >
            Preview
          </button>
          <button
            onClick={() => setTab('code')}
            className={`text-xs px-2.5 py-1 rounded-md font-medium ${tab === 'code' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 border border-gray-300'}`}
          >
            Code
          </button>
        </div>
