...
This renders with a colored border and icon on GitHub. Not all parsers support it, so it falls back to a standard blockquote.
...
Tables are a [GFM](https://github.github.com/gfm/#tables-extension-) extension, so they don't work in strict [CommonMark](https://commonmark.org/) parsers. See our full guide on [Markdown tables in PDF exports](/blog/markdown-table-pdf) for rendering tips.
...
Every element on this cheatsheet, including headings, tables, code blocks, and Mermaid diagrams, renders correctly in MDTool's PDF output. Paste your Markdown below and download a PDF in seconds, no signup required:
