...
GitHub renders `mermaid` fenced blocks as diagrams using the [Mermaid](https://mermaid.js.org/) JavaScript library. DevMark also renders them in both the preview and the PDF. Other common diagram types: `sequenceDiagram`, `erDiagram`, `gantt`, `pie`, `classDiagram`.
