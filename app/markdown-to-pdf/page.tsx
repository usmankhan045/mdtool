...
export const metadata: Metadata = {
  title: 'Markdown to PDF Converter — Free, Instant & No Login Required',
  description: 'Convert Markdown to PDF instantly in your browser. Supports GitHub Flavored Markdown, code blocks with syntax highlighting, tables, images, and Mermaid diagrams. Free forever, no signup.',
  ...
  openGraph: {
    ...
    url: 'https://devmark.tools/markdown-to-pdf',
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
  alternates: {
    canonical: 'https://devmark.tools/markdown-to-pdf',
  },
};
...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. DevMark fully supports GitHub Flavored Markdown including tables, task lists, strikethrough, fenced code blocks with syntax highlighting, and autolinks.',
  },
  {
    q: 'Does the converted PDF support syntax highlighting in code blocks?',
    a: 'Yes. Code blocks are automatically syntax-highlighted using highlight.js, which supports over 190 programming languages including JavaScript, Python, TypeScript, Rust, Go, and more.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Mermaid diagrams in your Markdown (```mermaid blocks) are rendered and included in the PDF export.',
  },
  {
...
export default function MarkdownToPdfPage() {
  return (
    <>
      <StructuredData type="tool" name="Markdown to PDF Converter" url="/markdown-to-pdf" />
