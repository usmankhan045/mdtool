...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Inline style attributes are dropped. Markdown has no equivalent for CSS, so colors, fonts, and custom spacing applied via style="..." simply have no Markdown syntax to map to and are removed along with the rest of the presentation layer.',
  ...
  },
  {
    ...
    a: 'Yes. Click "Upload .html" or drag and drop a .html or .htm file directly onto the input panel, with no need to open the file and copy its contents manually.',
  ...
  },
  {
    ...
    a: 'They’re dropped entirely. onclick, onload, and other event-handler attributes are behavior, not content, and Markdown has no mechanism to represent executable JavaScript, so they’re stripped along with <script> tags during conversion.',
  ...
  },
  {
    ...
    a: 'No. All conversion happens entirely in your browser using JavaScript. Your content never leaves your device, and there’s no upload step, even when you use the file-upload option.',
